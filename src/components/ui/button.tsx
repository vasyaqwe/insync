...
const buttonVariants = cva(
   `inline-flex items-center relative before:shadow-[0_0_0_1px] justify-center whitespace-nowrap gap-2 rounded-[.65rem] before:rounded-[.7rem]
    text-sm font-medium before:z-[-1] before:bg-gradient-to-b before:from-background/25 before:inset-0 before:absolute isolate ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 
      ...
      variants: {
         variant: {
            default: `bg-primary text-primary-foreground shadow-button-primary active:shadow-inner-primary py-[8px] 
                ...
                before:to-background/5 hover:bg-primary/90 before:shadow-primary`,
            destructive: `bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-button-primary 
                active:text-destructive-foreground/95 active:shadow-inner-primary before:to-background/5 before:shadow-destructive`,
            ...
            secondary: `bg-secondary text-secondary-foreground hover:bg-secondary/75 shadow-button-secondary
                active:shadow-inner-secondary before:to-border/25 before:shadow-border`,
